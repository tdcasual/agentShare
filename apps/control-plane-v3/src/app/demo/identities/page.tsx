  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="h-12 w-12 animate-spin rounded-full border-4 border-[var(--kw-primary-200)] border-t-[var(--kw-error)]" />
      </div>
    );
  }
  ...
  return (
    <main id="main-content" className="space-y-3 sm:space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          <h1 className="text-3xl font-bold text-[var(--kw-text)]">{t('identities.title')}</h1>
      ...
      <Card className="bg-[var(--kw-amber-surface)]/80 border border-[var(--kw-amber-surface)] dark:border-[var(--kw-dark-amber-surface)] dark:bg-[var(--kw-dark-amber-surface)]">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <Card className="flex items-center gap-4 p-4">
          ...
          <div>
            <p className="text-2xl font-bold text-[var(--kw-text)]">{identities.length}</p>
        ...
        <div className="flex gap-2">
          ...
          <div className="flex rounded-full border border-[var(--kw-primary-200)] bg-[var(--kw-surface)] p-1 dark:bg-[var(--kw-dark-bg)]">
            <button
              ...
              className={cn(
                'rounded-full p-2 transition-colors focus-visible:ring-2 focus-visible:ring-[var(--kw-primary-400)]',
                viewMode === 'grid'
                ...
                >
                  <Image
                    ...
                    className={cn(
                      ...
                      identity.type === 'human'
                        ? 'border-[var(--kw-human-accent)]'
                        : 'border-[var(--kw-agent-accent)]'
                    )}
                  />
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <h2 className="font-semibold text-[var(--kw-text)]">
      ...
      {showCreateModal && (
        <div
          data-testid="create-identity-panel"
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <button
              ...
              className="bg-[var(--kw-sky-surface)]/50 rounded-xl border-2 border-[var(--kw-sky-surface)] p-6 text-center transition-colors hover:bg-[var(--kw-sky-surface)]"
            >
            ...
            <button
              type="button"
              onClick={() => setShowCreateModal(false)}
              className="bg-[var(--kw-green-surface)]/50 rounded-xl border-2 border-[var(--kw-green-surface)] p-6 text-center transition-colors hover:bg-[var(--kw-green-surface)]"
            >
    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : 'text-[var(--kw-text-muted)] hover:bg-[var(--kw-primary-50)] dark:text-[var(--kw-dark-text-muted)]'
      )}
    >
      {label} ({count})
    </button>
