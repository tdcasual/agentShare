...
export default function DemoHubPage() {
  return (
    <div className="space-y-8">
      <section className="overflow-hidden rounded-[2rem] border border-[var(--kw-amber-surface)]/80 bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.18),_transparent_42%),linear-gradient(135deg,rgba(255,251,235,0.95),rgba(255,247,237,0.9))] p-8 shadow-[0_20px_60px_-30px_rgba(180,83,9,0.35)] dark:border-[var(--kw-dark-amber-surface)]/70 dark:bg-[radial-gradient(circle_at_top_left,_rgba(251,191,36,0.18),_transparent_38%),linear-gradient(135deg,rgba(33,24,12,0.96),rgba(49,31,12,0.92))]">
        <div className="grid gap-8 lg:grid-cols-[1.35fr_0.9fr] lg:items-end">
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-base leading-7 text-amber-950/80 md:text-lg dark:text-[var(--kw-warning)]/80">
          ...
          <div className="grid gap-3 rounded-[1.5rem] border border-[var(--kw-amber-surface)]/80 bg-white/75 p-5 text-sm text-stone-700 shadow-sm dark:border-[var(--kw-dark-amber-surface)]/80 dark:bg-stone-950/30 dark:text-stone-200">
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        {SANDBOX_ROUTES.map((route) => (
          <article
            key={route.demoHref}
            className="group rounded-[1.75rem] border border-[var(--kw-border)]/80 bg-white/85 p-6 shadow-[0_16px_45px_-35px_rgba(24,24,27,0.35)] transition-transform duration-200 hover:-translate-y-0.5 dark:border-stone-800 dark:bg-stone-950/60"
          >
            <div className="flex h-full flex-col gap-5">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <Link
                  href={route.demoHref}
                  className="inline-flex items-center justify-between rounded-2xl border border-amber-300 bg-[var(--kw-amber-surface)]/80 px-4 py-3 text-sm font-medium text-amber-950 transition-colors hover:bg-amber-200 dark:border-amber-700 dark:bg-amber-950/40 dark:text-[var(--kw-warning)] dark:hover:bg-amber-900/50"
                >
                  Open sandbox
      ...
      <section className="rounded-[1.5rem] border border-dashed border-stone-300 bg-[var(--kw-surface-alt)]/80 p-6 dark:border-[var(--kw-dark-border)] dark:bg-stone-950/40">
