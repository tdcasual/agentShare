...
const HubContent = memo(function HubContent({ email, role }: { email: string; role: string }) {
  ...
  return (
    <section id="main-content" className="space-y-5 sm:space-y-8 lg:space-y-10">
      ...
      <Card className="dark:bg-[var(--kw-dark-surface)]/90 border border-[var(--kw-border)] bg-[var(--kw-surface)] p-3 sm:p-4">
      ...
      <Card className="dark:bg-[var(--kw-dark-surface)]/90 bg-[var(--kw-surface)]/95 border border-[var(--kw-border)] p-3 sm:p-4 dark:border-[var(--kw-dark-border)]">
              ...
              <Card className="space-y-4 p-3 sm:p-4 lg:p-5">
                ...
                <div className="space-y-3">
                  {adminAccountList.map((account) => (
                    <div
                      key={account.id}
                      className="dark:bg-[var(--kw-dark-surface-alt)]/60 bg-[var(--kw-surface)]/70 rounded-xl border border-[var(--kw-border)] p-3 sm:p-4 dark:border-[var(--kw-dark-border)]"
                    >
                  ...
                  {adminAccountList.length === 0 ? (
                    <div className="dark:bg-[var(--kw-dark-surface-alt)]/55 bg-[var(--kw-surface)]/70 rounded-xl border border-dashed border-[var(--kw-border)] p-3 text-sm text-[var(--kw-text-muted)] sm:p-4 dark:border-[var(--kw-dark-border)] dark:text-[var(--kw-dark-text-muted)]">
                      {t('hub.emptyHumans')}
                    </div>
                  ) : null}
                </div>
              ...
              <div className="divide-y divide-[var(--kw-border)]" role="list">
                ...
                {recentActivity.map((activity) => (
                  <div
                    key={activity.id}
                    role="listitem"
                    className="hover:bg-[var(--kw-surface-alt)]/50 flex items-center gap-3 p-3 transition-colors sm:gap-4 sm:p-4"
                  >
                    <div
                      className={cn(
