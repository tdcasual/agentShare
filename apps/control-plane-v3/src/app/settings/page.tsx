      ...
      <div className="grid gap-3 sm:gap-4 lg:gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        <Card variant="kawaii" className="space-y-3 sm:space-y-4 lg:space-y-5">
          ...
          <form className="space-y-4" onSubmit={handleInvite}>
            ...
            <div className="dark:bg-[var(--kw-dark-surface)]/80 bg-[var(--kw-surface)]/80 rounded-2xl border border-[var(--kw-border)] px-4 py-3 text-sm text-[var(--kw-text-muted)] dark:text-[var(--kw-dark-text-muted)]">
        ...
        <Card variant="feature" className="space-y-3 sm:space-y-4 lg:space-y-5">
          <div className="space-y-2">
            <div className="dark:bg-[var(--kw-dark-surface)]/80 bg-[var(--kw-surface)]/80 inline-flex items-center gap-2 rounded-full border border-[var(--kw-border)] px-3 py-1 text-xs font-medium text-[var(--kw-primary-600)]">
          ...
          <div className="dark:bg-[var(--kw-dark-surface)]/80 bg-[var(--kw-surface)]/80 rounded-xl border border-[var(--kw-border)] p-3 sm:p-4 lg:p-5">
...
function AccountRow({
  ...
  return (
    <Card className="dark:bg-[var(--kw-dark-surface)]/90 bg-[var(--kw-surface)]/90 space-y-4 border border-[var(--kw-border)]">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-2">
...
function SessionStat({
  ...
  return (
    <div className="dark:bg-[var(--kw-dark-surface)]/80 bg-[var(--kw-surface)]/80 rounded-2xl px-4 py-3">
