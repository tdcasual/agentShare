...
export function SectionNotice({ message }: SectionNoticeProps) {
  return (
    <div className="dark:bg-[var(--kw-dark-surface-alt)]/55 rounded-2xl border border-dashed border-[var(--kw-border)] bg-white/70 p-3 text-sm text-[var(--kw-text-muted)] sm:p-4 dark:border-[var(--kw-dark-border)] dark:text-[var(--kw-dark-text-muted)]">
      {message}
    </div>
  );
}
