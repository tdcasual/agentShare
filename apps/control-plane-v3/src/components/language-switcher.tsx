    ...
    return (
      <div className={cn('relative', className)} ref={isOpen ? containerRef : undefined}>
        <button
          ...
          className={cn(
            'flex h-9 min-h-[44px] w-9 min-w-[44px] items-center justify-center rounded-full transition-colors duration-200',
            'dark:bg-[var(--kw-dark-surface)]/80 bg-[var(--kw-surface)]/80 border border-[var(--kw-border)] dark:border-[var(--kw-dark-border)]',
