      ...
      <div className="flex h-16 items-center justify-between border-b border-[var(--kw-border)] px-4 dark:border-[var(--kw-dark-border)]">
        ...
        {device.isTabletPortrait && (
          <button
            ...
            className="min-h-[44px] min-w-[44px] rounded-lg p-2 transition-colors hover:bg-[var(--kw-surface-alt)] focus-visible:ring-2 focus-visible:ring-[var(--kw-primary-400)] dark:hover:bg-[var(--kw-dark-surface-alt)]"
