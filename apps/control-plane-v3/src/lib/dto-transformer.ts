...
export abstract class BaseTransformer<TDTO extends TransportDTO, TModel extends DomainModel>
...
> extends BaseTransformer<TDTO, TModel> {
  ...
  private cache = createTransformCache<TDTO, TModel>(
    (dto) => dto.id || JSON.stringify(dto)
  );
