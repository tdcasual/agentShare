...
const badgeVariants = {
  ...
  info:
    'bg-[var(--kw-sky-surface)] text-[var(--kw-sky-text)] border border-[var(--kw-sky-surface)] dark:bg-[var(--kw-dark-info-surface)] dark:text-[var(--kw-dark-sky)] dark:border-[var(--kw-dark-info-surface)]',
  // Identity-specific
  human:
  ...
  offline:
    'bg-[var(--kw-surface-alt)] text-[var(--kw-text-muted)] border border-[var(--kw-border)] dark:bg-[var(--kw-dark-surface-alt)] dark:border-[var(--kw-dark-border)]',
  away:
    'bg-[var(--kw-orange-surface)] text-[var(--kw-orange-text)] border border-[var(--kw-orange-surface)] dark:bg-[var(--kw-dark-warning-surface)] dark:text-[var(--kw-warning)] dark:border-[var(--kw-dark-warning-surface)]',
  busy:
    'bg-[var(--kw-rose-surface)] text-[var(--kw-rose-text)] border border-[var(--kw-error)] dark:bg-[var(--kw-dark-error-surface)] dark:text-[var(--kw-error)] dark:border-[var(--kw-dark-error-surface)]',
} as const;
