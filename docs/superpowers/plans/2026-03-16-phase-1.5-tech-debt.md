...
- [ ] **Step 1: Write the failing DB session test**
...
- [ ] **Step 5: Update config.py to default to SQLite for dev/test**
...
- [ ] **Step 3: Write ORM base with timestamp mixin**
...
- [ ] **Step 3: Write the base repository and all repository classes**
...
- [ ] **Step 1: Update conftest.py to use SQLite sessions**
...
- [ ] **Step 2: Migrate services to accept Session parameter**
...
- [ ] **Step 3: Migrate all routes to inject `session = Depends(get_db)`**
...
- [ ] **Step 4: Run all existing tests to verify they pass with new DB-backed services**
...
- [ ] **Step 1: Write the failing Redis lock test**
...
- [ ] **Step 4: Update task_service.claim_task to use Redis lock**
...
- [ ] **Step 3: Write idempotency middleware**
...
- [ ] **Step 4: Wire middleware into main.py for invoke/lease routes**
...
- [ ] **Step 3: Add BOOTSTRAP_AGENT_KEY to config**
...
- [ ] **Step 4: Rewrite auth.py to use DB lookup**
...
- [ ] **Step 5: Add agent CRUD routes and schema**
...
- [ ] **Step 6: Add bootstrap agent creation on startup in main.py**
...
- [ ] **Step 1: Wire getAgents() to real API**
...
- [ ] **Step 3: Create agent-key-display component**
...
- [ ] **Step 4: Update agents page with creation form**
...
- [ ] **Step 5: Verify manually (or with Playwright if available)**
...
- [ ] **Step 3: Write the adapter protocol and registry**
...
- [ ] **Step 4: Add adapter_type and adapter_config to Pydantic CapabilityRecord**
...
- [ ] **Step 1: Write the failing OpenAI adapter test**
...
- [ ] **Step 4: Register OpenAI adapter in registry**
...
- [ ] **Step 1: Rewire gateway.py to use adapters**
...
- [ ] **Step 2: Update docker-compose.yml with api service and healthchecks**
...
- [ ] **Step 3: Update existing tests to work with adapter-based gateway**
...
- [ ] **Step 4: Write E2E smoke test (Playwright)**
...
- [ ] All unit tests pass: `cd apps/api && python -m pytest -v`
- [ ] Web build succeeds: `cd apps/web && npm run build`
- [ ] Docker compose starts cleanly: `docker compose up -d`
- [ ] API healthcheck passes: `curl http://localhost:8000/healthz`
- [ ] E2E tests pass: `npx playwright test`
- [ ] `store.py` is no longer imported by any route or service (can be deleted)
- [ ] All secrets are stored only in SecretBackend, never in Postgres
- [ ] Bootstrap agent is auto-created on first startup
